...
VisionProviderError hierarchy from app/vision/providers/base.py.

Copied from rnd/providers/openai_provider.py for the final POC runtime.
Empirically unproven against a real API call (blocked on funding during
RND-003B) — mock-tested only, same as the rnd/ original.
"""
