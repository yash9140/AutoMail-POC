...
app/vision/providers/base.py so the caller doesn't need to know
anything Gemini-specific.

Copied from rnd/providers/gemini_provider.py for the final POC runtime.
The rnd/ original is left untouched.
"""
