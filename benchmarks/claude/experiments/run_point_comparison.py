"""Real-Claude-API interior-point grounding comparison CLI.
    ...
    python -m benchmarks.claude.experiments.run_point_comparison
...
from benchmarks.claude.experiments.point_strategies import ALL_POINT_STRATEGIES, POINT_SEMANTIC_KEYS, PointStrategy  # noqa: E402
