"""Real-Claude-API visual evaluation CLI.
    ...
    python -m benchmarks.claude.evaluation_runner --stage OUTLOOK_SEARCH
    python -m benchmarks.claude.evaluation_runner --case outlook_search_live_001
    python -m benchmarks.claude.evaluation_runner --runs 3
...
from benchmarks.claude.cases import EvalCase, PROJECT_ROOT as CASES_ROOT, get_cases, known_stages  # noqa: E402
from benchmarks.claude.metrics import (  # noqa: E402
