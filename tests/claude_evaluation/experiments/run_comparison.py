"""Real-Claude-API grounding-strategy comparison CLI.
    ...
    python -m tests.claude_evaluation.experiments.run_comparison
...
from tests.claude_evaluation.experiments.strategies import ALL_STRATEGIES, Strategy  # noqa: E402
