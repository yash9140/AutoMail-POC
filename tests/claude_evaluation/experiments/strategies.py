...
entirely under tests/claude_evaluation/experiments/ — none of them are
...
from tests.claude_evaluation import metrics
from tests.claude_evaluation.cases import EvalCase, RUNTIME_PROMPTS_DIR
from tests.claude_evaluation.experiments.schemas import CandidateListResponse, ComponentGroundingResponse
