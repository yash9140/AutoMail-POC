"""Structured-output parser format experiment (2026-09-03).
    ...
    python -m tests.claude_evaluation.experiments.run_parser_format_experiment
...
from tests.claude_evaluation.experiments.schemas import ComponentGroundingResponse  # noqa: E402
from tests.claude_evaluation.experiments.strategies import COMPONENT_GROUNDING_PROMPT_PATH, EXPERIMENTS_DIR  # noqa: E402
