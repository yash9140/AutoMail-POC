...
identical guarantee to tests/claude_evaluation/evaluation_runner.py.
"""
...
# --- Import-safety self-check (same guarantee as tests/claude_evaluation) ---
...
OUTPUT_DIR = PROJECT_ROOT / "evaluation_results" / "gemini_benchmark"
