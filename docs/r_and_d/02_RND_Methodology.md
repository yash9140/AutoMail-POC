...
| 14 | Final Findings | `docs/r_and_d/14_Final_RND_Findings.md` completed |

Each step has (or will have) a corresponding `docs/0N_*.md` file written
using the template below, and a row in
[docs/r_and_d/00_RND_INDEX.md](00_RND_INDEX.md) that is updated as soon as the step
produces a result.
...
Proceed to [docs/r_and_d/03_Screen_Capture.md](03_Screen_Capture.md) — RND-001,
