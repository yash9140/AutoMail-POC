...
> **AMENDED by RND-005A** (`docs/r_and_d/07A_Coordinate_Calibration.md`): the 0/4
...
too small and was redrawn during RND-002; see `docs/r_and_d/04_Outlook_Screenshot_Dataset.md`).
...
- **No OpenAI/Anthropic comparison** — both remain blocked on billing
  (`docs/r_and_d/05A_Multi_Provider_Readiness.md`); whether this grounding gap is
  Gemini-specific or common across providers is unknown.

## Conclusion

*(As originally written — see the amendment banner at the top of this
document and `docs/r_and_d/07A_Coordinate_Calibration.md` for the corrected
reading.)*
...
(100%, N=4). See `docs/r_and_d/07A_Coordinate_Calibration.md` for the full
